...
class BTreeIndex {
 public:
   ...
   */
  RC recursiveInsert(int stage, int key,  PageId& returnPid, int& returnKey, const RecordId& rid, PageId currPid);
  RC popedupRoot(PageId leftPid, PageId rightPid, int key);
  static const int INITIAL = -1;
  static const int LOCATION_ROOT = 0;
